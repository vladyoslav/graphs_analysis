...
**Цель:** сравнить время работы алгоритма Борувки на SPLA (Intel и NVIDIA OpenCL) и Apache Spark на реальных графах разного размера
...
- 4 ядра / 8 потоков
- 2.50 ГГц / 4.50 ГГц boost
- L1: 256 КБ, L2: 1 МБ, L3: 8 МБ

**GPU:** NVIDIA GeForce GTX 1650 Ti Mobile — 4 ГБ GDDR6
- драйвер 580.126.09
